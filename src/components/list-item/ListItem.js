			...
			<div className="flex justify-between items-center py-2">
				...
				<div className="flex">
					<img
						src={icon}
						alt="check icon"
						className="w-6 md:w-8 cursor-pointer mr-3 transition-all duration-150 ease-out sm:hover:ease-in sm:hover:opacity-70"
						onClick={() => toggleComplete(item.id)}
					/>
					<img
						src="/images/icons/trash-outline.svg"
						alt="trash icon"
						className="w-6 md:w-8 cursor-pointer transition-all duration-150 ease-out sm:hover:ease-in sm:hover:opacity-70"
